---
title: Linux
description: Get started quickly with newOS, a ChatGPT-alternative that runs on your own computer, with a local API server. Learn how to install newOS and select an AI model to start chatting.
keywords:
  [
    newOS,
...
# Linux Installation
To install newOS desktop on Linux, follow the steps below:
## Compatibility
Ensure that your system meets the following requirements to use newOS effectively:
