---
title: Website & Docs
description: Information about the newOS website and documentation.
keywords:
  [
    newOS,
...
- **`/guides/`**: Guides on how to use the newOS application. For end users who are directly using newOS.

- **`/developer/`**: Developer docs on how to extend newOS. These pages are about what people can build with our software.

- **`/api-reference/`**: Reference documentation for the newOS API server, written in Swagger/OpenAPI format.

- **`/changelog/`**: A list of changes made to the newOS application with each release.

- **`/blog/`**: A blog for the newOS application.
