---
title: Analytics
description: newOS's Analytics philosophy and implementation
keywords:
  [
    newOS,
...
Adhering to newOS's privacy preserving philosophy, our analytics philosophy is to get "barely-enough-to-function'.
